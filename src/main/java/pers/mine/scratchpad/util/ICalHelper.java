...
public class ICalHelper {
     ...
     * @return
     */
	public static String getICalText(Date startTime, Date endTime,
			String title, String organizerName, String organizerEmail,
			String location, String description,List<Attendee> attendees,VAlarm valarm) {
		if (startTime != null && endTime != null){
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
			String begin = format.format(startTime);
			String over = format.format(endTime);
			return getICalText(begin, over, title, organizerName, organizerEmail, location, description, attendees, valarm);
		}
		return "";
     ...
     * @return
     */
	public static String getICalText(String begin, String over,
			String title, String organizerName, String organizerEmail,
			String location, String description,List<Attendee> attendees,VAlarm valarm) {
...
//				String meetDateUTCStr = item.getAttribute4();//会议时间时区
				...
				if (!StringX.isEmpty(description)) {
					meeting.getProperties().add(
							new net.fortuna.ical4j.model.property.Description(
									description));
				}
				// 添加参加者 .
	 ...
	 * @return
	 */
	public static VAlarm createVAlarm(int triggerTime,int durationTime,int repeat,
